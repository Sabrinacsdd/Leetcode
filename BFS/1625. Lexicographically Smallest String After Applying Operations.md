...
class Solution {
    public String findLexSmallestString(String s, int a, int b) {
        ...
        while (!q.isEmpty()) {
            ...
            String curadd = add(cur, a);
            if (!set.contains(curadd)) {
                q.add(curadd);
                set.add(curadd);
                if (curadd.compareTo(small) < 0) {
                    small = curadd;
                }
            }
            
            
            String currotate = rotate(cur, b);
            if (!set.contains(currotate)) {
                q.add(currotate);
                set.add(currotate);
                if (currotate.compareTo(small) < 0) {
                    small = currotate;
                }
            }
